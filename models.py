...
train_features_file_path = working_directory + '/train_features.csv'
dataset = pd.read_csv(working_directory + '/data_train_task1_bis.csv')
dataset.rename(columns={'Unnamed: 0': 'feat'}, inplace=True)
dataset = dataset.drop(['feat'], axis=1)
data_labels = pd.read_csv(working_directory + '/DATA_Labels.csv')
data_labels.rename(columns={'Unnamed: 0': 'feat'}, inplace=True)
data_labels = data_labels.drop(['feat'], axis=1)
test_set = pd.read_csv(working_directory + '/data_test_task1_bis.csv')
test_set.rename(columns={'Unnamed: 0': 'feat'}, inplace=True)
test_set = test_set.drop(['feat'], axis=1)
all_labels = pd.read_csv(working_directory + '/train_labels.csv')
task1_results = '/task1_results.csv'
task2_results = '/task2_results.csv'

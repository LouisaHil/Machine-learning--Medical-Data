...
train_features_file_path = working_directory + '/train_features.csv'  # -> input train_featiures file path
test_features_file_path = working_directory + '/test_features.csv'  # -> input test_features file path
train_labels_file_path = working_directory + '/train_labels.csv'  # -> input train_label file path
